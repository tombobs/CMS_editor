...
namespace Editor2.Utils
{
    public class SerialisationService
    {
        public static void SerialiseDoc(DocModel doc)
        {
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(Constants.FolderPath + doc.Title + "-" + doc.Type + ".xml");
        ...
        public static DocModel GetDocByTitleAndType(string title, string type)
        {
            try
            {
                System.IO.StreamReader read = new System.IO.StreamReader(Constants.FolderPath + title + "-" + type + ".xml");
